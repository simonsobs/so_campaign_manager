...
def test_workflow_creation():
    ...
    assert workflow.resources == {"cpu": 4, "memory": "8GB", "time": "2h"}
...
def test_workflow_get_numeric_fields_basic():
    ...
    workflow.cpu_count = 8
    workflow.memory_mb = 1024
    workflow.timeout_seconds = 3600.5
    workflow.string_field = "not_numeric"
    workflow.list_field = [1, 2, 3]
...
def test_workflow_avoid_attributes_functionality():
    ...
    assert "numeric_field" in filtered_numeric
